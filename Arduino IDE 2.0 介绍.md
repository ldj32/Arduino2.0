...
##### 2.2.2绿色安装包，下载后只需解压，即可直接使用
![image](images/YIP45w-7isnqfLQSl-KVDw5MS8ofyPidgeg5dJp6xCc.png)



### [2.2 如何安装扩展库（以 Windows 为例）](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_23-%e5%a6%82%e4%bd%95%e5%ae%89%e8%a3%85%e8%bd%af%e4%bb%b6%e5%ba%93%ef%bc%88windows%e4%b8%ba%e4%be%8b%ef%bc%89)
##### **2.2.1使用 Arduino IDE 自带的库管理器下载安装库文件。(在线库)**
...
##### **2.2.2在开源平台下载库文件的方法，我们在GitCode上找到需要的库文件。(离线库)**
注：以gitcode平台举例，如果找不到需要的库可以去[Arduino - Home](https://www.arduino.cc/) 或者[GitHub](https://github.com/) 中寻找

* 登录 [AtomGit | GitCode - 全球开发者的开源社区,开源代码托管平台](https://gitcode.com/)
* 搜索需要的库文件，下载文件
* 解压并安装
* 将下载的库文件安装进Arduino中
可以通过“加载库>添加一个.ZIP库”方式直接将压缩文件加入。

![image](images/9FHx6gVI1AaOuoo70U8tZRQMsskybU1ZoCWGRm9RJ9I.png)

也可以将下载的压缩包文件解压，然后将解压出来的名为“Adafruit\_SleepyDog-master”的文件夹移至 “C:\\用户名\\Documents\\Arduino\\Libraries”\\”里， 并重命名为“Adafruit\_SleepyDog。

* 验证：重启IDE并测试



### [2.3 配置其他开发板](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_24-%e5%a6%82%e4%bd%95%e8%87%aa%e5%b7%b1%e7%bc%96%e5%86%99%e8%bd%af%e4%bb%b6%e5%ba%93)
  在Arduino IDE中，默认只支持Arduino官方开发板（如Uno、Mega、Nano等），但其他厂商的开发板使用不同的芯片架构，需要专门的工具支持。如果我们想使用Arudino IDE配置其他开发板，需要进行额外的操作。
...
   STM32：搜索"stm32"，安装"STM32duino by STM32"

   Arduino SAMD：搜索"samd"，安装"arduino SAMD boards"
...
## [五、常见错误排查](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=%e5%85%ad%e3%80%81%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af)
### [5.1 如何打开编译日志](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_61-%e5%a6%82%e4%bd%95%e6%89%93%e5%bc%80%e7%bc%96%e8%af%91%e6%97%a5%e5%bf%97)
...
### [5.2 如何通过编译错误定位解决问题](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_62-%e5%a6%82%e4%bd%95%e9%80%9a%e8%bf%87%e7%bc%96%e8%af%91%e9%94%99%e8%af%af%e5%ae%9a%e4%bd%8d%e8%a7%a3%e5%86%b3%e9%97%ae%e9%a2%98)
...
### [5.3 开发板故障排查](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_54-%e5%bc%80%e5%8f%91%e6%9d%bf%e6%95%85%e9%9a%9c%e6%8e%92%e6%9f%a5)
...
## [六、编写属于自己的扩展库](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=%e5%85%ad%e3%80%81%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af)
...
### [6.1 编写源文件头文件](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_62-%e5%a6%82%e4%bd%95%e9%80%9a%e8%bf%87%e7%bc%96%e8%af%91%e9%94%99%e8%af%af%e5%ae%9a%e4%bd%8d%e8%a7%a3%e5%86%b3%e9%97%ae%e9%a2%98)
...
### [6.2 在Arduino上使用自己的库](https://docs.emakefun.com/#/zh-cn/software/arduino_ide/arduino_ide.zh-CN?id=_62-%e5%a6%82%e4%bd%95%e9%80%9a%e8%bf%87%e7%bc%96%e8%af%91%e9%94%99%e8%af%af%e5%ae%9a%e4%bd%8d%e8%a7%a3%e5%86%b3%e9%97%ae%e9%a2%98)
